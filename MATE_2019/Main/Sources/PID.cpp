...
/**Specify a maximum input. If a single parameter is specified, the minimum is
 * set to (-maximum).
 * @param input
 */
 ...
 * @param ,inimum possible input value
 * @param maximum possible input value
 */
